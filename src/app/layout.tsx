  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <Footer />
        <a 
          href="https://wa.me/919999999999?text=Hi%20Saraansh,%20I'm%20interested%20in%20learning%20more%20about%20Noida%20properties." 
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:scale-110 transition-all duration-300 z-50 flex items-center justify-center hover:shadow-[#25D366]/40 hover:shadow-2xl"
